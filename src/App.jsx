      ...
      <div className="paper-card paper-stack rounded-xl p-6 max-w-sm w-full animate-fade-in">
        ...
        <div className="flex justify-end gap-3">
          <button onClick={onCancel}
            className="btn-classical px-4 py-2 text-sm text-ink-600 dark:text-ink-400 hover:text-ink-800 dark:hover:text-ink-200 hover:bg-ink-100 dark:hover:bg-ink-800 rounded-lg transition-colors cursor-pointer font-serif">
            Cancel
          </button>
          <button onClick={onConfirm}
            className={`btn-classical px-4 py-2 text-sm text-white rounded-lg transition-colors cursor-pointer font-serif ${
              danger
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="lg:hidden flex items-center gap-3 px-4 py-3 border-b border-ink-200 dark:border-ink-700 bg-ink-50/80 dark:bg-ink-900/80 backdrop-blur-sm">
          <button onClick={() => setSidebarOpen(true)}
            className="p-1.5 -ml-1 rounded-lg hover:bg-ink-100 dark:hover:bg-ink-800 text-ink-500 dark:text-ink-400 cursor-pointer"
          ...
          <h1 className="text-base font-semibold text-ink-800 dark:text-ink-200 font-display">
            Quill{activeTag ? `: #${activeTag}` : ''}
          </h1>
          <span className="text-xs text-ink-400 dark:text-ink-500 ml-auto font-serif">{allNotes.length}</span>
          {isSaving && (
            <span className="text-xs text-gold flex items-center gap-1 animate-pulse font-serif">
